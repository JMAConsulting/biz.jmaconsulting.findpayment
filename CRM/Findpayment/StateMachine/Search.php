...
class CRM_Findpayment_StateMachine_Search extends CRM_Core_StateMachine {
  ...
  public function __construct($controller, $action = CRM_Core_Action::NONE) {
    ...
    $this->_pages['CRM_Findpayment_Form_Search'] = NULL;
    ...
    if ($result) {
      $this->_pages['CRM_Findpayment_Form_Payment_Result'] = NULL;
    }
